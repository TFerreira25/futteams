<template>
    <AppLayout>
        <div class="mx-auto max-w-2xl">
            <h1 class="mb-6 text-3xl font-bold text-gray-900">✏️ Editar Jogo</h1>
...
const form = useForm({
    date: props.game?.date || new Date().toISOString().slice(0, 16),
    total_players: props.game?.total_players || 10,
});
